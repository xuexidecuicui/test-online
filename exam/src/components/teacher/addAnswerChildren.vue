  ...
  <div class="add">
    ...
    <el-tab-pane name="second">
      ...
      <el-tab-pane name="third">
        <span slot="label"><i class="el-icon-upload"></i>上传试题</span>
        <div class="box">
          <el-upload
            class="upload-demo"
            drag
            ...
            <div class="el-upload__tip" slot="tip">只能上传Excel表格且工作簿命名为(选择题，填空题，判读题，工作簿第一列为头部命名需要对应,判读题只需要写正确
              答案即可（正确T，错误F）
              )</div>
          </el-upload>
        </div>
...
export default {
  ...
  methods: {
    ...
    getParams() {
      ...
      this.uploadPara.paperId=paperId
