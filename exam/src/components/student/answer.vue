        ...
        <div class="right">
          ...
          <div class="operation">
            <ul class="end">
              ...
              <li @click="cancelMark()"><i class="iconfont icon-mark-o"></i><span>取消标记</span></li>
...
export default {
  ...
  methods: {
    ...
    cancelMark() { //标记功能
      switch(this.currentType) {
        case 1:
          this.topic[1][this.index]["isMark"] = false //选择题标记
          break
        case 2:
          this.topic[2][this.index]["isMark"] = false //填空题标记
          break
        case 3:
          this.topic[3][this.index]["isMark"] = false //判断题标记
      }
    },
    commit() { //答案提交计算分数
      /* 计算选择题总分 */
